...
export default function ValuesAndVision() {
  ...
  const values = [
    ...
    },
    {
      ...
      description:
        "We uphold strict professional discretion in all engagements.",
      icon: <Lock size={24} className="text-blue-600" />,
    },
    {
      title: "Client-Centric Approach",
      description:
        "Your success is our priority and assistance can reach to your footstep.",
          ...
          <div className="flex flex-col md:flex-row items-center justify-between mb-10">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-3">
                Our Professional Values <span className="text-blue-600">&</span>{" "}
                Confidentiality
              </h2>
                ...
                <div className="relative bg-blue-700 text-white p-5 rounded-lg transform rotate-3 shadow-lg">
                  <div className="transform -rotate-3">
                    ...
                    <p className="text-blue-100 text-center text-sm">
                      Delivering aviation regulatory expertise with precision
                      and care
                    </p>
                  </div>
                </div>
            ...
            {values.map((value, index) => (
              <div
                ...
                className={`bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 ${
                  isVisible
                    ? `opacity-100 animate-fade-in-${index + 1}`
                    : "opacity-0"
                }`}
        ...
        <div className="bg-gradient-to-r from-blue-800 to-blue-900 rounded-xl overflow-hidden shadow-2xl">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-2/3 p-8 lg:p-10">
              <div className="flex">
                <ChevronRight
                  className="text-blue-300 flex-shrink-0 mr-2 mt-1"
                  size={20}
                />
                <p className="text-white text-lg leading-relaxed italic">
                  "To be the leading provider of seamless, cost-effective
                  consultancy solutions, ensuring compliance, legal access, and
                  social justice. We strive to empower individuals, small
                  businesses, and underprivileged communities by making
                  regulatory processes more accessible, transparent, and fair—so
                  you can focus on growth, not bureaucracy."
                </p>
              </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center bg-blue-100 px-6 py-3 rounded-full">
            ...
            <span className="text-blue-800 font-medium">
              Aviation Regulatory Compliance Experts
            </span>
          </div>
        </div>
      </div>
