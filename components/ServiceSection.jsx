    ...
    <section className="w-full bg-white border-b border-gray-200">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-24">
        ...
        <h1
          ...
          style={{ fontFamily: "Georgia, serif", fontSize: "clamp(14px, 2.5vw, 20px)", fontWeight: "bold" }}
        >
        ...
        <p
          ...
          style={{ fontFamily: "Arial, sans-serif", fontSize: "clamp(12px, 1.8vw, 15px)", lineHeight: "1.8" }}
        >
          ...
          {sections.map((section) => (
            <div key={section.label}>
              <h2
                ...
                style={{ fontFamily: "Georgia, serif", fontSize: "clamp(12px, 2vw, 15px)", fontWeight: "bold" }}
              >
                {section.label}
              </h2>
              <ul
